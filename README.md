...
Each canonical case is stored once in `data/cases/case-NNN.js`. Cases 1 and 2 contain completed Reasoning layers. New cases are produced here as Exam Stem and Full Run only, then receive their Reasoning layer through the separate reasoning workflow without changing the case wording.
