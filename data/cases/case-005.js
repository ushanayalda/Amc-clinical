(function () {
  ...
  caseFive.hints = [
    ...
    c005Hint(6, "stem", "c005-task-assess", "Assess and manage the patient", ["amc-spec-2026", "amc-tips-2024"], "Reading task 1", "Assessment first, treatment later?", "Assessment and treatment run together here. In the first five minutes, call help, assess ABC, start treatment, take only treatment-linked history and reassess. Any deterioration interrupts the history.", "The two actions run together.", "Task 1 is immediate assessment, treatment and response.", "Keep most of the station time for this task."),
    ...
    c005Hint(8, "stem", "c005-task-examiner", "severity, important alternative diagnoses and further management", ["amc-spec-2026", "amc-tips-2024"], "Reading task 3", "How is the final minute different?", "Speak to the examiner now: state severity, compare the serious alternatives with the findings, then give investigations, escalation and disposition.", "Change audience and task at the prompt.", "The last minute completes the medical plan.", "Prepare one sentence for severity, one for alternatives and one for further care."),
    ...
    c005Hint(29, "run", "c005-run-response", "air entry remains reduced", ["nac-severity-2025", "nac-acute-asthma-2025"], "Reading partial improvement", "Saturation is 94% and she is more alert. Is the crisis over?", "Not yet. Oxygen has improved, but reduced air entry and short phrases show substantial obstruction remains. The improvement may allow intubation to be deferred only with continuous critical-care observation.", "One better number does not cancel the remaining respiratory signs.", "Sophie has partially responded but is still critically unwell.", "At the prompt, explain the danger and ongoing plan to her."),
    ...
    c005Hint(33, "run", "c005-run-tube-answer", "If you keep improving, we may avoid it", ["nac-acute-asthma-2025", "amc-tips-2024"], "Discussing possible intubation", "Can I reassure her that she will avoid a tube?", "Give the conditional truth. Sustained improvement may avoid it; worsening fatigue, oxygenation or carbon dioxide makes intubation the safer support. Tell her the experienced teams are ready.", "Promise only what the next reassessment can support.", "Sophie knows both possibilities and why the decision may change.", "Check that she understands intensive-care treatment is still required."),
    ...
    c005Hint(42, "run", "c005-run-end", "The station is complete", ["amc-tips-2024"], "Leaving the station", "Should I add prevention advice now?", "The station has ended. Take the useful pattern with you: read airflow, speech, alertness and carbon dioxide together; treat and reassess.", "Leave the extra prevention discussion here.", "This station is finished.", "Take one breath and begin the next stem without carrying this emergency into it.")
  ];

  caseFive.essentialHintIds = [
    "c005-hint-03", "c005-hint-06", "c005-hint-07", "c005-hint-08",
    "c005-hint-13", "c005-hint-14", "c005-hint-24", "c005-hint-25",
    "c005-hint-27", "c005-hint-28", "c005-hint-29", "c005-hint-30",
    "c005-hint-33", "c005-hint-35", "c005-hint-41", "c005-hint-42"
  ];

  var c005Journey = {
    "c005-hint-06": { clock: "0 to 5 minutes: assess, treat and reassess." },
    "c005-hint-13": {
      say: ["This is life-threatening acute asthma. Poor bilateral air entry, short speech, severe effort and low oxygen show that airflow is critically reduced."],
      deeper: ["Bronchial muscle contraction, airway-wall inflammation and mucus narrow many airways. Resistance rises most during exhalation, so air becomes trapped, breathing work rises and oxygen falls."]
    },
    "c005-hint-24": { clock: "Danger interrupts the history: repeat ABC and escalate now." },
    "c005-hint-27": {
      say: ["Raised carbon dioxide now means Sophie can no longer ventilate enough to remove it. The acidaemia confirms ventilatory failure."],
      deeper: ["Early in an asthma attack, rapid breathing usually lowers carbon dioxide. A rise during deterioration therefore signals exhaustion rather than improvement."]
    },
    "c005-hint-29": { clock: "After the interruption: reassess before returning to the requested explanation." },
    "c005-hint-30": { clock: "5 to 7 minutes: explain the assessment and ongoing plan." },
    "c005-hint-35": { clock: "7 to 8 minutes: severity, alternatives and further management." },
    "c005-hint-42": { clock: "Station closed: one breath, then leave this case here." }
  };

  caseFive.hints.forEach(function (hint) {
    var journey = c005Journey[hint.id];
    if (!journey) return;
