(function () {
  ...
  caseSix.masteryFocus = {
    ...
    tasks: [
      ...
      "Address concerns, management and disposition"
    ],
    transfer: "If Maya developed sudden hypotension and wheeze after amoxicillin but had neither throat symptoms nor a rash, which findings would still make you give adrenaline immediately?",
    transferAnswer: "Give IM adrenaline immediately. Sudden bronchospasm and hypotension after a likely medication trigger meet the clinical threshold for anaphylaxis even without rash, throat swelling or other skin findings.",
    transferChecks: [
      "Trigger and rapid timing",
      "Wheeze or respiratory impairment",
      "Blood pressure, perfusion or collapse",
      "Do not wait for skin or throat features"
    ],
    transferCitationIds: ["ascia-anaphylaxis-2026", "ascia-initial-flowchart-2026"]
  };
  ...
  caseSix.hints = [
    c006Hint(1, "stem", "c006-stem-role", "suburban medical clinic", ["healthdirect-breath-2025", "amc-spec-2026"], "Reading the setting", "Clinic. Can I begin as a routine consultation?", "Treat this as an emergency from the start. Sudden breathing difficulty and light-headedness may need clinic emergency medicines, resuscitation equipment and ambulance transfer before the cause is fully known.", "The setting limits resources, not urgency.", "You have a potentially unstable patient outside hospital.", "Plan help, monitoring and ABC assessment immediately."),
    ...
    c006Hint(15, "run", "c006-run-consent", "Yes. Please", ["ascia-anaphylaxis-2026", "amc-tips-2024"], "Receiving consent", "Do I need a longer procedure discussion?", "This brief discussion is enough for the immediate emergency. Maya has heard the diagnosis, danger, treatment and urgency and has agreed. Keep communicating while the injection proceeds.", "Emergency consent can be brief and informed.", "She agrees to immediate adrenaline.", "Give the correct intramuscular dose and record the time."),
    ...
    c006Hint(21, "run", "c006-run-first-response", "blood pressure is 90/56 mmHg", ["ascia-anaphylaxis-2026", "ascia-initial-flowchart-2026"], "Reading the first response", "The numbers are better. Is one dose enough?", "One dose has not been enough. Blood pressure remains low, hoarseness and wheeze persist, and she is still light-headed. Severe airway, breathing or circulatory features remain after five minutes.", "Improvement is not adequate response when dangerous features persist.", "The first dose helped but did not control the reaction.", "Give a second intramuscular adrenaline dose now."),
    ...
    c006Hint(28, "run", "c006-run-time", "The first task is complete", ["amc-spec-2026", "amc-tips-2024"], "Changing tasks", "Should I keep asking background questions?", "Monitoring and treatment continue, but the examiner has moved you to Maya's concerns, ongoing management and transfer. Leave the remaining background questions now.", "A prompt is a return point, not a disruption.", "Assessment and immediate management are complete for this station.", "Invite and answer the missing-rash concern."),
    ...
    c006Hint(38, "run", "c006-run-ambulance-arrival", "ambulance team arrives", ["anzcor-anaphylaxis-2026", "acsqhc-anaphylaxis-2021"], "Transferring care", "Are the requested tasks complete now?", "Yes. The two requested tasks are complete. If the examiner lets the transfer continue, give the ambulance team the current observations, treatment times, suspected trigger and recurrence risk while oxygen, monitoring and safe positioning continue.", "Do not invent an extra station task, but do not abandon safe transfer.", "Definitive transport support is present.", "If permitted, give the concise clinical handover shown next."),
    ...
    c006Hint(42, "run", "c006-run-end", "The station is complete", ["amc-tips-2024"], "Leaving the station", "Should I add an allergy lecture?", "The requested concerns, disposition and transfer are complete. Take the useful pattern with you: recognise multisystem failure, give adrenaline, position safely, repeat and reassess.", "A closed station needs no extra sentence.", "This station is finished.", "Take one breath and read the next stem from the beginning.")
  ];

  caseSix.essentialHintIds = [
    "c006-hint-02", "c006-hint-05", "c006-hint-06", "c006-hint-12",
    "c006-hint-14", "c006-hint-16", "c006-hint-17", "c006-hint-21",
    "c006-hint-22", "c006-hint-24", "c006-hint-25", "c006-hint-28",
    "c006-hint-31", "c006-hint-33", "c006-hint-35", "c006-hint-42"
  ];

  var c006Journey = {
    "c006-hint-05": { clock: "0 to 5 minutes: assess, treat, explain briefly and reassess." },
    "c006-hint-12": { clock: "Danger interrupts the clock: position safely and give adrenaline now." },
    "c006-hint-13": {
      say: ["Standing can abruptly reduce the remaining blood flow to Maya's heart and brain and cause collapse. Keep her safely positioned."],
      deeper: ["Allergic mediators dilate blood vessels and make them leak fluid. Venous return and blood pressure fall, so standing can remove the small amount of effective circulation that remains."]
    },
    "c006-hint-14": {
      say: ["Adrenaline directly treats the shock, airway swelling and wheeze. Antihistamines and steroids do not reverse those immediate threats."],
      deeper: ["Adrenaline constricts dilated vessels, reduces tissue swelling and relaxes bronchial smooth muscle, so it acts across all three failing systems at once."]
    },
    "c006-hint-22": { clock: "Five-minute reassessment: severe features remain, so repeat first-line treatment." },
    "c006-hint-25": { clock: "After stabilisation: return to the unfinished focused assessment." },
    "c006-hint-28": { clock: "5 to 8 minutes: concerns, ongoing management and disposition." },
    "c006-hint-33": {
      say: ["The line says overnight observation may be needed. For Maya, current guidance is firmer: repeat adrenaline plus intravenous fluid for hypotension makes overnight observation strongly recommended."],
      pause: "For this severe reaction, overnight observation is the safe plan.",
      recap: "Her response has improved, but the severity of the reaction still sets the observation plan.",
      reorient: "Then explain suspected-trigger documentation, avoidance and specialist follow-up.",
      clock: "Disposition: monitored transfer and overnight hospital observation."
    },
    "c006-hint-38": { clock: "Ambulance arrival: transfer the safety-critical sequence." },
    "c006-hint-42": { clock: "Station closed: one breath, then leave this case here." }
  };

  caseSix.hints.forEach(function (hint) {
    var journey = c006Journey[hint.id];
    if (!journey) return;
