(function () {
  ...
  caseSeven.masteryFocus = {
    ...
    tasks: [
      ...
      "Explain diagnosis and alternatives",
      "Address antibiotics and management"
    ],
    transfer: "If Margaret had the same cough and breathlessness but unilateral crackles, fever and no raised JVP or oedema, how would that change your leading diagnosis and immediate plan?",
    transferAnswer: "Fever with unilateral crackles and no venous congestion would move pneumonia ahead of pulmonary oedema. The existing hypoxaemia and respiratory distress still require oxygen, monitoring and ambulance transfer; commence protocol-based antibiotics when indicated without delaying transfer, while retaining other causes if the pattern does not fully fit.",
    transferChecks: [
      "Focal rather than bilateral lung findings",
      "Fever and infective features",
      "Absence of JVP elevation, oedema and orthopnoea",
      "Oxygenation and severity still determine disposition"
    ],
    transferCitationIds: ["qld-pccm-pneumonia-2025"]
  };
  ...
  caseSeven.sources = [
    ...
    {
      id: "qld-pccm-pneumonia-2025",
      title: "Primary Clinical Care Manual, 12th edition: Pneumonia",
      organisation: "Queensland Health and Royal Flying Doctor Service (Queensland Section)",
      date: "2025, v1.02 updated November 2025",
  ...
  caseSeven.reasoningCompass = {
    ...
    run: {
      ...
      anchor: "Deterioration interrupts the clock. Repeat ABC, escalate treatment and transfer, then return to the part of the task you paused."
    }
  };
  ...
  caseSeven.hints = [
    ...
    c007Hint(12, "run", "c007-run-early-assessment", "working hard to breathe", ["healthdirect-breath-2025", "amc-tips-2024"], "Acting on appearance", "Should I finish the history before calling the nurse?", "Call the nurse now. Visible respiratory effort and breathlessness at rest justify parallel observations, monitoring and emergency preparation. History can continue in short questions.", "Let her physiology set the order.", "Margaret appears significantly unwell.", "Request the full observations and keep her upright."),
    c007Hint(13, "run", "c007-run-observations", "oxygen saturation is 89% on room air", ["healthdirect-breath-2025", "anzcor-oxygen-2021"], "Interpreting observations", "Could this still be managed after the consultation?", "She needs emergency treatment and transfer. Hypoxaemia, respiratory rate 30, short sentences and breathlessness at rest require immediate oxygen, monitoring and an ambulance. The preserved blood pressure does not make low oxygen safe.", "Treat instability before completing the cause analysis.", "Margaret is hypoxaemic and in respiratory distress.", "Start titrated oxygen and monitored transfer now."),
    ...
    c007Hint(40, "run", "c007-run-ambulance", "ambulance team arrives", ["acsqhc-handover-2026", "anzcor-oxygen-2021"], "Transferring care", "Are the three requested tasks complete now?", "Yes. If the examiner lets the transfer continue, give a brief ambulance handover without treating it as a fourth station task. Oxygen, upright positioning and monitoring continue through the changeover.", "Do not invent another task, but do not abandon safe transfer.", "Margaret accepts monitored hospital transfer.", "If permitted, give the ambulance team the clinical sequence, treatment and response."),
    ...
    c007Hint(42, "run", "c007-run-handover", "Suspected acute decompensated heart failure", ["acsqhc-handover-2026", "qas-pulmonary-oedema-2017"], "Stating assessment and treatment", "How much detail belongs here?", "Name pulmonary oedema, give the hypoxaemia and congestion findings, then state oxygen, nitrate and protocol-guided diuretic treatment. The receiving team can then see what changed and how she responded.", "A safe handover connects findings to action.", "The working diagnosis and treatment are explicit.", "Finish with current monitoring, ECG information and unresolved trigger checks."),
    ...
    c007Hint(44, "run", "c007-run-end", "The station is complete", ["amc-tips-2024"], "Leaving the station", "Should I add prevention advice?", "The requested explanation, antibiotic concern and management are complete. Take the useful pattern with you: hear the patient's explanation, test it against physiology, treat danger and explain the safer plan.", "The consultation ends when the examiner stops it.", "This station is finished.", "Take one breath and read the next stem without carrying forward the antibiotic debate.")
  ];

  caseSeven.essentialHintIds = [
    "c007-hint-03", "c007-hint-06", "c007-hint-07", "c007-hint-08",
    "c007-hint-12", "c007-hint-13", "c007-hint-14", "c007-hint-17",
    "c007-hint-24", "c007-hint-30", "c007-hint-31", "c007-hint-34",
    "c007-hint-35", "c007-hint-36", "c007-hint-37", "c007-hint-44"
  ];

  var c007Journey = {
    "c007-hint-06": { clock: "0 to 4 minutes: focused assessment and immediate safety." },
    "c007-hint-13": { clock: "Danger interrupts the consultation: oxygen, monitoring and transfer now." },
    "c007-hint-16": {
      say: ["Breathlessness that worsens flat and wakes her gasping raises concern about fluid pressure in the lungs."],
      deeper: ["Lying flat shifts blood from the legs and abdomen toward the chest. If the heart cannot manage that volume, pressure rises in the lung vessels and breathing worsens."]
    },
    "c007-hint-24": {
      say: ["This is acute decompensated heart failure with pulmonary oedema. Raised JVP, bilateral crackles, oedema and low oxygen connect the lung and peripheral findings to one circulatory problem."],
      deeper: ["Raised cardiac filling pressure moves fluid into lung tissue and alveoli, producing crackles and hypoxaemia. Systemic venous pressure produces JVP elevation and leg oedema."]
    },
    "c007-hint-29": { clock: "After treatment: reassess, keep transfer moving, then return to the requested explanation." },
    "c007-hint-30": { clock: "4 to 6 minutes: diagnosis and important alternatives." },
    "c007-hint-35": { clock: "6 to 8 minutes: antibiotics concern and management plan." },
    "c007-hint-40": { clock: "Transfer point: keep oxygen and monitoring continuous." },
    "c007-hint-44": { clock: "Station closed: one breath, then leave this case here." }
  };

  caseSeven.hints.forEach(function (hint) {
    var journey = c007Journey[hint.id];
    if (!journey) return;
