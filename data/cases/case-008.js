(function () {
  ...
  caseEight.hints = [
    ...
    c008Hint("c008-hint-12", "run", "c008-run-findings", "10 litres per minute through a non-rebreather mask", ["c008-copdx-oxygen"], "Reading current treatment", "High-concentration oxygen is already running. Should I remove it?", "Keep oxygen running, but control the dose. Sudden removal could cause hypoxaemia. Change to a controlled device, prescribe a target and watch him closely while you obtain a blood gas.", "Correct the dose; keep treating the hypoxaemia.", "He is receiving much more oxygen than usually required for COPD.", "Now combine the device with saturation, breathing effort and conscious state."),
  ...
  var c008Journey = {
    ...
    "c008-hint-14": {
      say: ["Ninety-nine per cent is being produced by high-concentration oxygen while Peter remains drowsy and distressed. He is above the usual 88% to 92% target, so prescribe controlled oxygen and check the blood gas."],
      deeper: ["Excess oxygen can worsen ventilation-perfusion mismatch and the Haldane effect. Both reduce effective carbon dioxide removal and can worsen hypercapnia."]
    },
    "c008-hint-24": {
