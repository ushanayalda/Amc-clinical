(function () {
  ...
  caseNine.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Fix the switches: assessment and management until minute 4, essential collateral until minute 6, then explanation to Helen and Mark." }
      ],
    ...
    run: {
      ...
      anchor: "If airway, breathing or conscious state worsens, interrupt the current task, stabilise, then return to its unfinished verb."
    }
  };
  ...
  caseNine.hints = [
    ...
    c009Hint("c009-hint-07", "stem", "c009-task-history", "essential collateral history", ["c009-amc-spec", "c009-amc-tips"], "Anchoring task two", "What makes collateral essential rather than complete?", "Ask for onset and last-known-well times, symptom order, seizure or trauma, baseline function, vascular history, anticoagulants, recent bleeding and surgery. Follow only answers that alter immediate treatment.", "Mark helps because Helen's speech is impaired, but Helen remains part of the conversation.", "Collateral fills treatment-critical gaps; it is not a full medical history.", "Keep the final two minutes for explanation.", "4 to 6 minutes"),
    ...
    c009Hint("c009-hint-16", "run", "c009-run-findings", "capillary glucose is 6.2 mmol/L", ["c009-av-cpg", "c009-stroke-guideline"], "Reading the examination", "Face, arm, speech and leg findings. Has the evidence earned a working diagnosis?", "Yes. Sudden right face and limb weakness with language difficulty localises to the left cerebral hemisphere and strongly supports acute stroke. Glucose is normal, so hypoglycaemia does not explain it.", "You still cannot distinguish ischaemia from haemorrhage clinically.", "This is a suspected left hemispheric acute stroke with an unknown onset.", "Call Triple Zero now and give both times."),
    c009Hint("c009-hint-17", "run", "c009-run-ambulance-order", "suspected acute stroke", ["c009-stroke-guideline", "c009-anzcor-stroke", "c009-av-cpg"], "Activating the pathway", "Should I finish the examination before calling?", "No. Pre-notification gives the receiving stroke service time to prepare imaging and treatment. The nurse can call while you continue monitoring and focused assessment.", "Clinic tests must not delay transfer.", "The stroke pathway is active with last-known-well and discovery times recorded.", "Address Mark's suggestion of driving."),
    ...
    c009Hint("c009-hint-34", "run", "c009-run-end", "The station is complete", ["c009-amc-spec", "c009-amc-tips"], "Leaving the station", "Should I replay the case now?", "No. Release Helen's case. One breath, then read the next role, symptoms and tasks without assuming another stroke.", "The next sudden neurological presentation may be a mimic.", "Case 9 is finished.", "Begin the next stem from its own evidence.")
  ];
})();
