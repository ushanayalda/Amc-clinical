(function () {
  ...
  caseTen.masteryFocus = {
    ...
    tasks: [
      ...
      "Interpret and obtain focused history",
      "Explain assessment and management"
    ],
    transfer: "If Min-jae's glucose normalised but his left-sided weakness persisted, how would your working diagnosis and immediate action change?",
    transferAnswer: "Once glucose is normal but unilateral weakness remains, hypoglycaemia no longer explains the whole presentation. Treat this as possible concurrent acute stroke: repeat the neurological examination and continue immediate stroke transfer and reperfusion imaging assessment.",
    transferChecks: [
      "Confirm sustained glucose correction",
      "Document the remaining focal deficit",
      "Preserve onset and last-known-well times",
      "Continue stroke imaging without delay"
    ],
    transferCitationIds: ["c010-stroke-guideline"]
  };
  caseTen.sources = [
  ...
  caseTen.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Set the task change points: assess and manage until minute 4, interpret and take focused history until minute 6, then explain the assessment and plan." }
      ],
    ...
    run: {
      ...
      anchor: "If consciousness falls, swallowing becomes unsafe or focal signs return, interrupt the task, stabilise and reassess, then return to the part you paused."
    }
  };
  ...
  caseTen.hints = [
    ...
    c010Hint("c010-hint-07", "stem", "c010-task-interpret", "Interpret the information provided", ["c010-amc-spec", "c010-amc-tips"], "Anchoring task two", "They give me information, then ask for history. What is the order?", "First say what the supplied findings mean and whether they change the urgency. Then ask Min-jae and Soo-jin only for details that help explain the episode, change treatment or reveal an important alternative.", "Let the findings decide which history question comes next.", "Task two joins interpretation with a focused cause-and-safety history.", "At minute 6, stop gathering information and explain your assessment.", "Minutes 4 to 6: interpret first, then ask the focused questions it raises."),
    c010Hint("c010-hint-08", "stem", "c010-task-explain", "assessment and management plan", ["c010-amc-spec", "c010-amc-tips", "c010-communication"], "Anchoring task three", "What must Min-jae and Soo-jin understand by the end?", "Explain your leading assessment, the findings that support it, what remains uncertain, what treatment is happening and why the next setting or monitoring plan is safest.", "Separate what you know now from what still needs checking.", "Task three is the assessment, uncertainty and management plan.", "Let the evidence disclosed during the run determine the explanation.", "Minutes 6 to 8: explain the assessment and plan to both of them."),
    ...
    c010Hint("c010-hint-34", "run", "c010-run-end", "The station is complete", ["c010-amc-spec", "c010-amc-tips"], "Leaving the station", "Should I keep deciding whether it was stroke?", "The case has ended. Take one breath, then let the next presentation show you what is happening.", "Stroke and hypoglycaemia both stay with this case.", "Case 10 is finished.", "Read the next role, symptoms and tasks from the beginning.")
  ];

  caseTen.essentialHintIds = [
    "c010-hint-03", "c010-hint-06", "c010-hint-07", "c010-hint-08",
    "c010-hint-11", "c010-hint-13", "c010-hint-14", "c010-hint-15",
    "c010-hint-18", "c010-hint-23", "c010-hint-25", "c010-hint-26",
    "c010-hint-27", "c010-hint-28", "c010-hint-31", "c010-hint-34"
  ];

  var c010Journey = {
    "c010-hint-13": { clock: "Danger interrupts the assessment: correct the glucose now." },
    "c010-hint-17": {
      say: ["Low glucose can produce a stroke-like focal deficit. The repeat examination after correction will show whether Min-jae's one-sided weakness follows the glucose level."],
      deeper: ["The brain does not fail uniformly when glucose is inadequate. Some networks can be disrupted more than others, producing a focal deficit even though no single peripheral nerve has failed."]
    },
    "c010-hint-18": { clock: "Five-minute recovery check: repeat every original neurological finding." },
    "c010-hint-23": {
      say: ["The usual gliclazide dose met almost no food, diarrhoeal illness and reduced kidney reserve. That combination explains why glucose fell and why it may fall again."],
      deeper: ["Modified-release gliclazide stimulates pancreatic insulin release for many hours. Poor intake supplies little glucose, while illness and impaired medicine handling can prolong vulnerability."]
    },
    "c010-hint-25": { clock: "Recurrence interrupts the history: treat again and reassess swallowing and neurology." },
    "c010-hint-27": { clock: "6 to 8 minutes: explain the diagnosis, uncertainty and monitoring plan." },
    "c010-hint-34": { clock: "Station closed: one breath, then leave this case here." }
  };

  caseTen.hints.forEach(function (hint) {
    var journey = c010Journey[hint.id];
    if (!journey) return;
