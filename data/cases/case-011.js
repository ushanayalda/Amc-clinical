(function () {
  ...
  caseEleven.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Fix the switches: assess and manage until minute 4, focused collateral and interpretation until minute 6, then explain diagnosis and ongoing management." }
      ],
    ...
    run: {
      ...
      anchor: "If vomiting, airway protection, pupils, breathing or GCS worsen, interrupt the task, stabilise immediately, then return to the unfinished task verb."
    }
  };
  ...
  caseEleven.hints = [
    ...
    c011Hint("c011-hint-06", "stem", "c011-task-assess", "Assess Leila and discuss your initial management", ["c011-amc-spec", "c011-amc-tips"], "Anchoring task one", "What must happen before minute 4?", "ABCDE, glucose, GCS, pupils and focal neurology; monitoring, intravenous access, nil by mouth, head positioning, stroke-team activation and urgent CT preparation.", "Do not wait for every historical detail before imaging.", "The first four minutes combine assessment and immediate protection.", "Reserve minute 4 to 6 for collateral and interpretation.", "0 to 4 minutes"),
    c011Hint("c011-hint-07", "stem", "c011-task-history", "focused collateral history", ["c011-amc-spec", "c011-amc-tips"], "Anchoring task two", "Which collateral changes treatment now?", "Exact last-normal and onset times, symptom order, seizure, trauma, loss of consciousness, anticoagulant name and last dose, previous brain events, allergies, baseline independence and expressed wishes.", "Focused collateral serves current decisions.", "Nadia fills gaps while Leila is drowsy.", "Keep the final two minutes for explanation.", "4 to 6 minutes"),
    ...
    c011Hint("c011-hint-13", "run", "c011-run-primary-findings", "blood pressure is 218/116 mmHg", ["c011-stroke-guideline"], "Reading severe hypertension", "Should I lower it immediately to normal?", "No. Severe hypertension matters, but the target and rate depend on the stroke type and specialist protocol. Abrupt uncontrolled reduction can reduce cerebral perfusion.", "Record it, monitor closely and obtain imaging before subtype-specific treatment.", "Leila has severe hypertension during an acute focal brain syndrome.", "Now place conscious state and focal signs beside it."),
    ...
    c011Hint("c011-hint-20", "run", "c011-run-results", "4 millimetres of midline shift", ["c011-stroke-guideline", "c011-stroke-summary", "c011-stroke-standard"], "Reading the scan", "Now has the diagnosis been earned?", "Yes. This is a left putaminal intracerebral haemorrhage with intraventricular extension and midline shift. The deep left bleed explains right-sided weakness; blood and swelling explain headache, vomiting and reduced consciousness.", "Now treatment should follow confirmed haemorrhage, not suspected ischaemia.", "The scan confirms a sizeable deep brain bleed with early mass effect.", "Add INR and warfarin to choose reversal."),
    ...
    c011Hint("c011-hint-28", "run", "c011-run-time", "Please explain your likely diagnosis", ["c011-amc-spec", "c011-amc-tips"], "Changing tasks", "The patient just deteriorated. What do I do with the clock?", "The airway emergency correctly interrupted the plan. Once the team has secured it, return to the unfinished task verb: explain the diagnosis and ongoing management to Nadia.", "Do not apologise for spending time on deterioration.", "Immediate stabilisation is complete enough to communicate the plan.", "Use plain language and short sections.", "6 to 8 minutes"),
    ...
    c011Hint("c011-hint-34", "run", "c011-run-end", "The station is complete", ["c011-amc-spec", "c011-amc-tips"], "Leaving the station", "Should I keep reviewing the reversal dose?", "No. Release Leila's case. One breath, then let the next stem establish its own pathology and priorities.", "Do not carry haemorrhage into every focal deficit.", "Case 11 is finished.", "Begin the next case with the role, setting and tasks.")
  ];
})();
