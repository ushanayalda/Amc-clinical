(function () {
  ...
  caseTwelve.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Fix the switches: assess and manage for 3 minutes, collateral and interpretation for 3, explain for 1, then hand over for 1." }
      ],
    ...
    run: {
      ...
      anchor: "If airway, breathing, perfusion, urine output or conscious state worsens, interrupt the task, stabilise and escalate, then return to the unfinished task verb."
    }
  };
  ...
  caseTwelve.hints = [
    ...
    c012Hint("c012-hint-03", "stem", "c012-stem-patient", "become confused", ["c012-delirium"], "Reading the cognitive change", "Confusion gives too many possibilities. Where do I start?", "Start with physiology and time course: oxygenation, glucose, perfusion, temperature, medicines, pain, retention and focal neurology. Then seek infection, metabolic disturbance, organ failure, intoxication and structural brain disease from the findings.", "Do not begin with a long dementia assessment.", "This is acute confusion of unknown cause.", "Add the reduced intake and its consequences."),
    ...
    c012Hint("c012-hint-07", "stem", "c012-task-assess", "Assess Marisol and discuss your management", ["c012-amc-spec", "c012-amc-tips"], "Anchoring task one", "What must fit in three minutes?", "ABCDE, glucose, perfusion, hydration, focused source and neurological examination, monitoring, access and any time-critical treatment supported by the findings, followed by reassessment.", "Assessment and treatment must move together.", "Task one covers immediate physiology and first management.", "Switch at minute 3 to essential collateral and interpretation.", "0 to 3 minutes"),
    c012Hint("c012-hint-08", "stem", "c012-task-history", "essential collateral history", ["c012-amc-spec", "c012-amc-tips", "c012-delirium"], "Anchoring task two", "Which details are essential?", "Last normal, first change, rigors or pain, respiratory, abdominal and urinary symptoms, urine output, falls, medicines, kidney history, baseline cognition and function, allergies and any advance-care plan.", "Ask what changes current treatment first.", "Collateral and interpretation share minutes 3 to 6.", "Protect one minute for explanation and one for handover.", "3 to 6 minutes"),
    ...
    c012Hint("c012-hint-17", "run", "c012-run-recognition", "Activate the adult sepsis pathway", ["c012-sepsis-standard", "c012-qld-pathway", "c012-qld-resources"], "Recognising the emergency", "Has the evidence earned sepsis?", "Yes. Suspected infection with acute confusion, tachypnoea and impaired perfusion is enough to treat possible sepsis now. Blood pressure can remain normal while organ dysfunction develops.", "Do not wait for lactate, cultures or hypotension before starting the pathway.", "Marisol has suspected sepsis with delirium and poor perfusion.", "Monitor, obtain access and measure urine output while investigations begin."),
    ...
    c012Hint("c012-hint-19", "run", "c012-run-treatment", "within 60 minutes", ["c012-sepsis-standard", "c012-qld-pathway"], "Starting antibiotics", "Should I wait for urine and ultrasound?", "No. Give empiric intravenous antibiotics under the local pathway after checking allergies and recent microbiology. Obtain cultures first only when this does not delay the first dose.", "Source confirmation and timely treatment are not competing jobs.", "Antibiotics are started for suspected urinary sepsis.", "Give fluid in a measured amount and reassess."),
    ...
    c012Hint("c012-hint-35", "run", "c012-run-end", "The station is complete", ["c012-amc-spec", "c012-amc-tips"], "Leaving the station", "Should I replay whether I gave enough fluid?", "No. The case has ended. One breath, then begin the next stem without assuming that confusion means sepsis or dehydration.", "Let each new patient supply their own physiology and cause.", "Case 12 is finished.", "Read the next role, symptoms and tasks from the beginning.")
  ];
})();
