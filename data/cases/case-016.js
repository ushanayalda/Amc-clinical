(function () {
  ...
  caseSixteen.masteryFocus = {
    ...
    transfer: "If a similarly shocked young patient had marked right-ventricular dilation instead of global left-ventricular failure, which urgent cause would you re-prioritise before accepting myocarditis?",
    transferAnswer: "Marked right-ventricular dilation in shock should move high-risk pulmonary embolism and obstructive shock ahead of myocarditis. Look for right-heart pressure overload and venous-thromboembolism evidence, then use haemodynamic stability to choose immediate CT pulmonary angiography or bedside specialist-led reperfusion assessment.",
    transferChecks: [
      "RV dilation and pressure-overload pattern",
      "Whether LV failure is actually present",
      "DVT or PE clues",
      "Stability determines imaging and escalation"
    ],
  ...
  caseSixteen.sources = [
    ...
    { id: "racgp-pe-2022", title: "Pulmonary embolus: Assessment and management in primary care", organisation: "Royal Australian College of General Practitioners", date: "September 2022", url: "https://www1.racgp.org.au/ajgp/2022/september/pulmonary-embolus" },
    { id: "thanz-vte-2019", title: "Guidelines for the diagnosis and management of venous thromboembolism", organisation: "Thrombosis and Haemostasis Society of Australia and New Zealand", date: "2019", url: "https://www.mja.com.au/journal/2019/210/5/new-guidelines-thrombosis-and-haemostasis-society-australia-and-new-zealand" },
  ...
  caseSixteen.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Set the task change points: assess and manage to minute 3, interpret and escalate to minute 6, explain to minute 7, hand over to minute 8." }
      ],
    ...
    run: {
      ...
      anchor: "If breathing, circulation, rhythm or conscious state worsens, interrupt the task, repeat ABCDE and escalate support; then return to the question or action you paused."
    }
  };
  caseSixteen.hints = [
    ...
    buildHint16("c016-hint-07", "stem", "c016-task-assess", "Assess Zara and discuss your initial management", ["amc-spec-2026", "amc-tips-2024", "acsqhc-deterioration-2026"], "Anchoring task one", "What must fit into three minutes?", "Start with ABCDE, monitoring, access, senior help and support for any immediate abnormality. Keep the history short and run it beside those actions.", "Initial management starts before the exact cause is known.", "Task one is to find and treat immediate airway, breathing or circulation problems.", "Let the actual findings decide whether fluid is helpful or harmful."),
    buildHint16("c016-hint-task-interpret", "stem", "c016-task-interpret", "Interpret the findings and investigation results and discuss your next steps", ["amc-spec-2026", "amc-tips-2024"], "Anchoring task two", "How do I move from results to next steps?", "Put the symptoms, examination and supplied results together. State what appears to be failing, which causes still fit and what the evidence makes you do next.", "Interpret the whole pattern, then act on it.", "Task two is the leading problem, possible causes and next steps.", "Build from the first assessment rather than repeating it.", "Minutes 3 to 6: interpret the evidence and discuss next steps."),
    buildHint16("c016-hint-task-explain", "stem", "c016-task-explain", "Explain your assessment and management plan", ["amc-spec-2026", "amc-tips-2024"], "Anchoring task three", "How should minute six change?", "Stop technical discussion and speak to Zara and Rory. Explain the leading assessment, which findings support it, what support is happening now, what remains uncertain and what comes next.", "One minute means clear causes and actions, not every result.", "Minute 6 to 7 belongs to explanation.", "Reserve the final minute for handover."),
    buildHint16("c016-hint-08", "stem", "c016-task-handover", "concise clinical handover", ["amc-spec-2026", "acsqhc-communication-2026"], "Anchoring the final minute", "What will the senior clinician need in one minute?", "Give Zara's identity, the presenting problem, the most important findings available by then, your working diagnosis, treatment and response, current risks and the next action.", "Choose information that changes immediate care.", "The handover carries the current problem, response and unfinished work.", "Track only the few findings that change during the station.", "Minute 7 to 8: concise senior handover."),
    ...
    buildHint16("c016-hint-19", "run", "c016-run-history", "chest pain, palpitations, fainting", ["aci-cardiac-sob-2026", "amc-tips-2024"], "Returning after emergency actions", "Have I missed the history task?", "You haven't. Immediate support is underway, so return to the symptoms that separate ischaemia, arrhythmia, syncope, infection and thromboembolism.", "Return to the questions you paused.", "ABCDE and first management are complete.", "Clarify chronology and red flags without slowing the investigations."),
    buildHint16("c016-hint-20", "run", "c016-run-history-answer", "Five days ago I had fever", ["esc-myocarditis-2025"], "Reading chronology", "Does the preceding fever prove myocarditis?", "A recent infection makes myocardial inflammation plausible, but acute coronary disease, pulmonary embolism, sepsis, toxins and other cardiomyopathies still need active exclusion.", "Sequence supports a possibility; it does not prove causation.", "The viral link is relevant but unconfirmed.", "Use chest symptoms, rhythm, risk factors and imaging to separate the causes."),
    ...
    buildHint16("c016-hint-24", "run", "c016-run-results", "Troponin is markedly elevated", ["qas-cardiogenic-shock-2026", "aci-cardiac-sob-2026"], "Reading ECG and troponin", "No ST elevation. Is coronary disease excluded?", "A non-diagnostic ECG does not exclude an acute coronary cause, and markedly raised troponin shows myocardial injury rather than its cause.", "An injury marker is not a diagnosis.", "The heart is injured, but the mechanism still needs definition.", "Use the global echo pattern and later coronary imaging."),
    ...
    buildHint16("c016-hint-27", "run", "c016-run-support", "mean arterial pressure of at least 65 mmHg and clinical perfusion", ["qas-cardiogenic-shock-2026"], "Supporting pressure", "Is reaching 65 the finish?", "The pressure is a minimum guide. Warmth, refill, conscious state, urine, lactate and rhythm show whether organs are actually receiving enough flow.", "Treat perfusion, not a number alone.", "Noradrenaline supports pressure while congestion limits fluid.", "Read the repeat organ and rhythm findings."),
    ...
    buildHint16("c016-hint-31", "run", "c016-run-time", "Please explain your assessment", ["amc-spec-2026", "amc-tips-2024"], "Turning to Zara and Rory", "What if I have more investigation detail?", "The clinical discussion is complete. Explain the pump problem, organ-flow consequence, current support, diagnostic uncertainty and tertiary plan in everyday language.", "The prompt has changed your audience.", "Assessment and next steps are complete.", "Speak directly to Zara and Rory."),
    ...
    buildHint16("c016-hint-33", "run", "c016-run-cause-question", "Did the flu infection damage her heart", ["acsqhc-communication-2026", "esc-myocarditis-2025"], "Answering cause uncertainty", "Can I simply say yes?", "Acknowledge that heart-muscle inflammation is a serious possibility, then say the timing alone cannot prove it and other treatable causes must be excluded.", "Be specific about what is suspected and what remains uncertain.", "Rory wants a cause, but the immediate priority is support.", "Explain how coronary imaging, MRI and biopsy answer different questions."),
    ...
    buildHint16("c016-hint-38", "run", "c016-run-end", "The station is complete", ["amc-tips-2024"], "Letting the station finish", "Should I keep solving the cause?", "The station has ended. Take one breath and begin the next case from its own symptoms, physiology and tasks.", "Leave myocarditis here.", "Case 16 is complete.", "Read the next stem from the first line." )
  ];
  caseSixteen.hints.forEach(function (hint, index) { hint.id = "c016-hint-" + String(index + 1).padStart(2, "0"); });
  caseSixteen.essentialHintIds = [
    "c016-hint-04", "c016-hint-07", "c016-hint-08", "c016-hint-09",
    "c016-hint-10", "c016-hint-13", "c016-hint-18", "c016-hint-27",
    "c016-hint-28", "c016-hint-29", "c016-hint-30", "c016-hint-31",
    "c016-hint-32", "c016-hint-34", "c016-hint-39", "c016-hint-41"
  ];
  var clockByHint16 = {
    "c016-hint-07": "Minutes 0 to 3: ABCDE, immediate support and a short parallel history.",
    "c016-hint-08": "Minutes 3 to 6: interpret the evidence and discuss next steps.",
    "c016-hint-09": "Minute 6 to 7: explain the assessment and plan to Zara and Rory.",
    "c016-hint-10": "Minute 7 to 8: concise senior handover.",
    "c016-hint-21": "Immediate support is running. Return briefly to the symptoms that separate ischaemia, rhythm, infection and thromboembolism.",
    "c016-hint-30": "Before minute 6: use the repeat perfusion, urine, lactate and rhythm to decide whether support is enough.",
    "c016-hint-31": "New ventricular ectopy is another interruption: escalate rhythm readiness and tertiary support now.",
    "c016-hint-34": "Minute 6: turn to Zara and Rory and explain the current problem and uncertainty.",
    "c016-hint-39": "Final minute: transfer the shock pattern, response, rhythm risk and tertiary plan.",
    "c016-hint-41": "Time is complete. One breath, then begin the next stem from its first line."
  };
  var deeperByHint16 = {
    "c016-hint-16": ["A weak left ventricle raises pressure behind it: left-ventricular failure → pulmonary venous pressure → interstitial lung water → B-lines and orthopnoea."],
    "c016-hint-27": ["An ejection fraction of 15% means very little of the filled ventricular volume is ejected with each beat. Low forward flow explains hypotension and oliguria; backward pressure explains lung and venous congestion."],
    "c016-hint-28": ["Fulminant describes the rapid, severe heart-failure presentation. Myocarditis remains suspected until coronary causes are excluded and inflammation is supported by MRI or tissue when indicated."],
    "c016-hint-32": ["Temporary mechanical support can maintain circulation while the heart recovers, a cause-specific treatment works, or a longer-term decision is made."]
  };
  caseSixteen.hints.forEach(function (hint) {
    if (clockByHint16[hint.id]) hint.clock = clockByHint16[hint.id];
    if (deeperByHint16[hint.id]) hint.deeper = deeperByHint16[hint.id];
  });
})();
