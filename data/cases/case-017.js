(function () {
  ...
  caseSeventeen.masteryFocus = {
    ...
    transfer: "A patient with a high cord injury has warm hypotension and relative bradycardia, but a repeat scan now shows intra-abdominal free fluid. How does that change your interpretation and immediate priorities?",
    transferAnswer: "Intra-abdominal free fluid means the hypotension can no longer be attributed to neurogenic shock alone. Treat this as mixed shock with haemorrhage until proven otherwise: activate major-haemorrhage and trauma source-control pathways while maintaining spinal protection; vasopressor support is an adjunct, not a substitute for blood and bleeding control.",
    transferChecks: [
      "New free fluid and abdominal findings",
      "Perfusion, lactate and haemoglobin trend",
      "Response to blood-based resuscitation",
      "Continue parallel spinal and respiratory care"
    ],
    transferCitationIds: ["aci-traumatic-injury-2026", "qas-spinal-injury-2026"]
  };
  ...
  caseSeventeen.reasoningCompass = {
    stem: {
      ...
      steps: [
        ...
        { time: "1 to 2 minutes", text: "Set the task change points: initial assessment to minute 3, focused neurology and next steps to minute 6, explanation to minute 7, handover to minute 8." }
      ],
    ...
    run: {
      ...
      anchor: "If breathing, circulation or conscious state worsens, interrupt the neurological sequence, repeat ABCDE and escalate; then return to the examination step you paused."
    }
  };
  caseSeventeen.hints = [
    ...
    buildHint17("c017-hint-06", "stem", "c017-task-assess", "Assess Arlo and discuss your initial management", ["amc-spec-2026", "amc-tips-2024"], "Anchoring task one", "What is initial management here?", "Hold four blocks: protect alignment, complete trauma ABCDE, support the physiology, then call the trauma and spinal teams early.", "The first three minutes protect life and cord.", "Detailed neurology belongs to the next task.", "Keep the tasks separate without delaying danger treatment."),
    ...
    buildHint17("c017-hint-task-explain", "stem", "c017-task-explain", "Explain your assessment and management plan", ["amc-spec-2026", "amc-tips-2024"], "Anchoring task three", "What changes at minute six?", "Stop the formal interpretation and speak to Arlo for one minute. Explain what is known, what remains uncertain, what is being protected and the urgent next treatment.", "Keep the prognosis within what the current examination can support.", "Minute 6 to 7 belongs to explanation.", "Keep the final minute for clinical handover."),
    buildHint17("c017-hint-08", "stem", "c017-task-handover", "concise clinical handover", ["amc-spec-2026", "acsqhc-communication-2026"], "Anchoring the final minute", "Which facts must be handed over?", "Use four blocks: who he is and what happened; the most important findings available by then; treatment and response; then the next urgent action.", "Lead with the problem that needs attention first.", "The senior clinician should know what happened, what you found, what you did and what must happen next.", "Keep a brief note of any change in breathing, circulation or neurology as it appears.", "Minute 7 to 8: concise senior handover."),
    ...
    buildHint17("c017-hint-23", "run", "c017-run-symptoms-answer", "numb lower down", ["qas-spinal-injury-2026"], "Hearing a sensory level", "Can I call the level from this sentence?", "It suggests a level below the shoulders, but formal dermatomal testing and key muscle groups are needed. Sacral sparing helps determine completeness.", "Patient description guides the examination; it does not replace it.", "There is a major motor and sensory deficit.", "Perform the structured neurological assessment."),
    ...
    buildHint17("c017-hint-27", "run", "c017-run-neuro-results", "no sacral sparing", ["qas-spinal-injury-2026", "aospine-haemodynamic-2024"], "Reading neurological severity", "Does no sacral sparing mean recovery is impossible?", "It supports a severe complete pattern on this examination, but early swelling and spinal shock can alter findings. Repeat standardised examinations and avoid absolute prognosis.", "Severity is clear; outcome is not.", "A severe cervical cord injury is strongly supported.", "Separate spinal shock from the circulatory problem."),
    buildHint17("c017-hint-28", "run", "c017-run-interpret", "spinal shock", ["qas-spinal-injury-2026", "aospine-haemodynamic-2024"], "Separating two similar terms", "Spinal shock and neurogenic shock sound interchangeable. Are they?", "They are different. Spinal shock is temporary loss of reflexes and flaccid tone below the cord injury. Neurogenic shock is hypotension and often bradycardia from lost sympathetic tone. They can occur together.", "Name the neurological and circulatory problems separately.", "Arlo currently has both patterns.", "Support circulation with vasopressor while continuing trauma surveillance."),
    ...
    buildHint17("c017-hint-36", "run", "c017-run-time", "Please provide your handover", ["amc-spec-2026", "acsqhc-communication-2026"], "Turning to the handover", "What comes first?", "Lead with axial-load mechanism, unstable C5 to C6 injury and severe deficit. Then give neurogenic shock, exclusion of bleeding, vasopressor response, worsening respiratory function and urgent airway and spinal plans.", "The prognosis conversation is complete.", "The final minute transfers current risk.", "Use the current problems and actions, not every normal result."),
    ...
    buildHint17("c017-hint-38", "run", "c017-run-end", "The station is complete", ["amc-tips-2024"], "Letting the station finish", "Should I keep predicting recovery?", "The station has ended. Take one breath, then begin the next case with its first line and tasks.", "Leave this spinal injury here.", "Case 17 is complete.", "Read the next stem from the first line." )
  ];
  caseSeventeen.hints.forEach(function (hint, index) { hint.id = "c017-hint-" + String(index + 1).padStart(2, "0"); });
  caseSeventeen.essentialHintIds = [
    "c017-hint-03", "c017-hint-06", "c017-hint-07", "c017-hint-08",
    "c017-hint-09", "c017-hint-13", "c017-hint-18", "c017-hint-19",
    "c017-hint-28", "c017-hint-29", "c017-hint-32", "c017-hint-33",
    "c017-hint-34", "c017-hint-35", "c017-hint-37", "c017-hint-39"
  ];
  var clockByHint17 = {
    "c017-hint-06": "Minutes 0 to 3: protect the spine, complete ABCDE and treat breathing or circulation threats.",
    "c017-hint-07": "Minutes 3 to 6: complete and interpret the focused neurological assessment.",
    "c017-hint-08": "Minute 6 to 7: explain the assessment and urgent plan to Arlo.",
    "c017-hint-09": "Minute 7 to 8: concise senior handover.",
    "c017-hint-18": "Danger interrupts the neurological sequence: support circulation now, then return to the focused cord examination.",
    "c017-hint-28": "Before minute 6: complete the key motor, sensory and sacral findings, then interpret them beside imaging.",
    "c017-hint-33": "Falling vital capacity interrupts every other task. Escalate airway support before fatigue develops.",
    "c017-hint-37": "Final minute: transfer the injury, deficit, shock, respiratory trend and urgent actions.",
    "c017-hint-39": "Time is complete. One breath, then begin the next stem from its first line."
  };
  var deeperByHint17 = {
    "c017-hint-09": ["Keep airway, breathing, circulation and neurological changes together rather than retelling the full examination."],
    "c017-hint-06": ["Maintain alignment; monitor, oxygenate, obtain access, warm and search for bleeding; involve trauma, spinal, anaesthetic and intensive-care support according to the findings."],
    "c017-hint-18": ["A high cord injury can interrupt sympathetic pathways: loss of vascular tone → vasodilation and warm skin; loss of cardiac sympathetic drive → relative bradycardia."],
    "c017-hint-22": ["Electric pain at impact suggests transient cord or nerve-root irritation from axial force and movement, but it does not define the final neurological level."],
    "c017-hint-28": ["Sacral sparing means some function remains in the lowest cord segments. Its presence supports an incomplete injury; its absence early on does not by itself settle long-term recovery."],
    "c017-hint-29": ["Neurogenic shock is circulatory failure from lost sympathetic tone. Spinal shock is temporary loss of reflexes and flaccidity below the cord injury."]
  };
  caseSeventeen.hints.forEach(function (hint) {
    if (clockByHint17[hint.id]) hint.clock = clockByHint17[hint.id];
    if (deeperByHint17[hint.id]) hint.deeper = deeperByHint17[hint.id];
  });
})();
