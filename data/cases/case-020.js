(function () {
  ...
  caseTwenty.hints = [
    ...
    buildHint20("c020-hint-07", "stem", "c020-task-handover", "concise clinical handover", ["amc-spec-2026", "acsqhc-communication-2026"], "Anchoring the final minute", "Which facts must the senior hear?", "Identity, amount and pattern of bleeding, circulatory effect, relevant medicine and last dose, important results, ongoing loss, treatment already given, location evidence and the next intervention.", "A concise handover carries current risk and action, not every question asked.", "Minute 7 to 8 is the senior handover.", "Start the run with the first safety action and preserve these final facts."),
    ...
    buildHint20("c020-hint-14", "run", "c020-run-primary-findings", "Dark red blood and clot are on the bed pad", ["acsqhc-deterioration-2026", "nba-critical-bleeding-2025"], "Confirming ongoing loss", "Does dark red blood prove a lower source?", "No. It confirms current gastrointestinal blood loss, but colour alone cannot safely locate brisk bleeding. The soft, non-tender abdomen does not reduce the circulatory urgency.", "Blood colour alone does not locate the source.", "There is active gastrointestinal bleeding with impaired perfusion; the source remains uncertain.", "Escalate and begin the local critical bleeding response."),
    ...
    buildHint20("c020-hint-18", "run", "c020-run-action-resuscitation", "History continues during resuscitation", ["nba-critical-bleeding-2025", "amc-tips-2024"], "Working in parallel", "Have I lost the history task?", "No. The team can secure access, collect blood and warm Alma while you ask short questions that change management. Stop again if her circulation or consciousness worsens.", "The team can resuscitate while you ask short questions, provided you stop if she worsens.", "Immediate treatment is active and the source is still uncertain.", "Clarify the bleeding pattern first."),
