(function () {
  ...
  caseThirtyThree.masteryFocus = {
    ...
    transferAnswer: "Obtain senior review, cultures and intravenous access promptly. If lumbar puncture is safe and can be completed without delaying antibiotics, collect cerebrospinal fluid first; otherwise give ceftriaxone and perform lumbar puncture later. Give dexamethasone 0.15 mg/kg before or with ceftriaxone and, when indicated, continue it six-hourly for four days under local protocol. Do not obtain routine CT solely to decide whether lumbar puncture is possible, or give shock fluid or adrenaline without physiological evidence that they are needed.",
    transferChecks: ["Neurological and haemodynamic stability", "Contraindications to lumbar puncture", "Whether sampling would delay antibiotics", "Dexamethasone timing and ongoing indication"],
  ...
  caseThirtyThree.hints = [
    ...
    buildHint33("c033-hint-18", "run", "c033-run-antibiotic-plan", "never delay ceftriaxone", ["rch-meningitis-2024", "rch-meningococcal-2026"], "Protecting the time-critical treatment", "Should cultures or dexamethasone come first?", "Take blood culture only if it causes no delay. Give dexamethasone 0.15 mg/kg before or with ceftriaxone, then six-hourly for four days when indicated under the local protocol. Neither sampling nor steroid preparation should delay ceftriaxone.", "Do not let extra tests delay the antibiotic.", "Possible invasive infection is being treated through IO access.", "Support circulation and reassess immediately."),
    ...
    buildHint33("c033-hint-29", "run", "c033-run-handover-prompt", "concise handover", ["amc-spec-2026", "acsqhc-communication-2026"], "Recovering the final task", "What order keeps this handover safe?", "Give identity and weight, change from usual, initial shock findings, deterioration, doses and routes, response, remaining drowsiness, the next dexamethasone dose and ongoing plan, deferred lumbar puncture and PICU destination.", "Lead with current risk and the treatment trend.", "The final minute is for transfer of care.", "Keep normal findings only when they explain a decision."),
  ...
  var deeperByHint33 = {
    ...
    "c033-hint-18": ["Bacterial killing can intensify meningeal inflammation, so dexamethasone is timed with the first antibiotic and may reduce inflammatory injury and hearing loss. If the first dose follows antibiotics, give it ideally within four hours and never after 12 hours. Stop it if N meningitidis is confirmed."],
