(function () {
  ...
  caseThirtySeven.masteryFocus = {
    ...
    clinical: "Across poisonings, a scheduled antidote duration is a time to reassess, not an automatic stop. Check whether the toxin has cleared, organ injury is settling and the person is recovering, using treatment-specific criteria and toxicology advice.",
    ...
    transferAnswer: "No. The nomogram is designed for one acute ingestion with a reliable time, so it cannot safely interpret staggered or unknown-time exposure. Start or continue acetylcysteine when the history or results meet treatment criteria and follow serial paracetamol and liver tests. If treatment extends beyond 20 hours, time alone does not permit stopping: seek toxicology advice and continue until the person is clinically well, ALT or AST is falling and INR is below 2.",
    transferChecks: ["Single versus staggered ingestion", "Reliability of the ingestion time", "Paracetamol concentration and liver tests", "Clinical recovery, falling ALT or AST, INR below 2 and toxicology advice"],
  ...
  caseThirtySeven.hints = [
    ...
    buildHint37("c037-hint-21", "run", "c037-run-reassessment-plan", "two hours before completion", ["mja-paracetamol-2020", "vic-poisons-2026"], "Checking the 20-hour checkpoint", "Does the clock decide when acetylcysteine stops?", "No. Repeat paracetamol and ALT near completion so treatment can continue without a gap if needed. Twenty hours is a reassessment point, not permission to stop. If treatment extends, stop only with toxicology advice when Mirela is clinically well, ALT or AST is falling and INR is below 2.", "Twenty hours tells you when to reassess. It does not prove recovery.", "Near-completion tests decide whether the standard course can finish; prolonged treatment has separate recovery criteria.", "Now keep a plan for an infusion reaction without abandoning indicated treatment."),
  ...
  caseThirtySeven.essentialHintIds = [
    ...
    "c037-hint-20", "c037-hint-21", "c037-hint-24", "c037-hint-25", "c037-hint-30", "c037-hint-31"
  ];
  var clockByHint37 = {
  ...
  var deeperByHint37 = {
    ...
    "c037-hint-21": ["Near completion, paracetamol above 10 mg/L or ALT above 50 U/L and rising means treatment continues. For prolonged treatment, falling ALT or AST suggests liver-cell injury is settling, INR below 2 supports hepatic synthetic recovery, and being clinically well checks the whole patient. The clock supplies none of those answers."]
  };
