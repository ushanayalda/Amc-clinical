...
function buildShell(manifest) {
  ...
  html = html.replace(/content="source-case-001-four-view"/g, `content="${buildId}"`);
  html = html.replace(/window\.__BUILD_ID__ = "source-case-001-four-view";/g, `window.__BUILD_ID__ = ${JSON.stringify(buildId)};`);
